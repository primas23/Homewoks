namespace StringExtensions
{
    ...
    {
        /// <summary>
        /// Converts string to the MD5 hash.
        /// </summary>
        /// <param name="input">The input.</param>
        /// <returns>String in a MD5 hash format.</returns>
        ...
        /// <summary>
        /// Converts string to the boolean.
        /// </summary>
        /// <param name="input">The input.</param>
        ...
        /// <summary>
        /// Converts string to the short (Int16).
        /// </summary>
        /// <param name="input">The input.</param>
        ...
        /// <summary>
        /// Converts string to the integer (Int32).
        /// </summary>
        /// <param name="input">The input.</param>
        ...
        /// <summary>
        /// Converts string to the long (Int64).
        /// </summary>
        /// <param name="input">The input.</param>
        ...
        /// <summary>
        /// Converts the cyrillic to latin letters.
        /// </summary>
        /// <param name="input">The input.</param>
        ...
        /// <summary>
        /// Convert`s the latin to cyrillic keyboard.
        /// </summary>
        /// <param name="input">The input.</param>
        /// <returns>Converted string.</returns>
        ...
        /// <summary>
        /// Converts string to the valid username.
        /// </summary>
        /// <param name="input">The input.</param>
        ...
        /// <summary>
        /// Converts string to valid latin file name.
        /// </summary>
        /// <param name="input">The input.</param>
        /// <returns>Valid latin file name string.</returns>
        ...
        /// <summary>
        /// Converts string to web content type.
        /// </summary>
        /// <param name="fileExtension">The file extension.</param>
        /// <returns>the web content type.</returns>
        ...
        /// <summary>
        /// Converts string to the byte array.
        /// </summary>
        /// <param name="input">The input.</param>
